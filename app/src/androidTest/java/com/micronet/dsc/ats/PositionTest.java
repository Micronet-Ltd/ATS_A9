...
public class PositionTest extends AndroidTestCase {
    ...
    public void test_checkIdling() {
        ...
        assertFalse(test.isInQueue(EventType.EVENT_TYPE_IDLING_OFF)); // no messages yet
        ...
        assertTrue(test.isInQueue(EventType.EVENT_TYPE_IDLING_OFF)); // now we got our off message
        service.queue.clearAll();
        ...
        assertFalse(test.isInQueue(EventType.EVENT_TYPE_IDLING_OFF)); // now we got our off message
    ...
    public void test_checkSpeeding() {
        ...
        assertFalse(test.isInQueue(EventType.EVENT_TYPE_SPEEDING));

        // and over.
        assertTrue(position.checkSpeeding(3001));
        assertTrue(test.isInQueue(EventType.EVENT_TYPE_SPEEDING));
        service.queue.clearAll();
    ...
    public void test_checkAccelerating() {
        ...
        assertTrue(test.isInQueue(EventType.EVENT_TYPE_ACCELERATING));
        service.queue.clearAll();
    ...
    public void test_checkBraking() {
        ...
        assertTrue(test.isInQueue(EventType.EVENT_TYPE_BRAKING));
        service.queue.clearAll();
    ...
    public void test_checkCornering() {
        ...
        assertTrue(test.isInQueue(EventType.EVENT_TYPE_CORNERING));
        service.queue.clearAll();
    ...
    public void test_checkPing_Bearing() {
        ...
        assertFalse(test.isInQueue(EventType.EVENT_TYPE_PING));
